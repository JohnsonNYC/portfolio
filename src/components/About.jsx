        ...
        <div className='about'>
            ...
            <div className='about-text-picture'>
                <div className='about-text-container'>
                    <p className='about-text'> GET ARCHIVO NARROW TO WORK is a well-known photographer, filmmaker, influencer, and savvy businesswoman who inspires her millions of followers around the globe on how to maximise the human experience and live a life of wonder.</p>
